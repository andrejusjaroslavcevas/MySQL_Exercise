...
CREATE TABLE players_facts(
	...
	season VARCHAR(100),
	player_market_value_million_euros INT,
	transfer_fee INT,
...
(player_age, position, season, player_market_value_million_euros, transfer_fee)
VALUES 
...
SELECT p.player_id AS 'Player ID', p.player_name AS 'Name', p.player_last_name AS 'Last Name', pf.player_age AS 'Age', pf.position AS 'Position', ti.joined_team AS 'Team', pf.season AS 'Season'
FROM players as p
